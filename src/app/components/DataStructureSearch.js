                ...
                <div className="flex-1 min-h-0">
                    ...
                    <div className="flex gap-4 h-full">
                        ...
                        {searchTerm && structures.length > 0 && (
                            <div
                                className={`transition-all duration-300 ease-in-out shrink-0 overflow-y-auto ${
                            ...
                            >
                                {isExpanded && (
                                    <button
                                        ...
                                        className="mb-4 flex items-center text-blue-600 hover:text-blue-800 transition-colors duration-200 sticky top-0 bg-gray-50 z-10 p-2 rounded"
                                    >
